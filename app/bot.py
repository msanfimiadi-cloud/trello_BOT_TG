...
def main() -> None:
    ...
    for command, callback in (("start", handlers.start), ("help", handlers.help), ("cancel", handlers.cancel), ("new", handlers.new), ("status", handlers.status), ("check_trello", handlers.check_trello)):
