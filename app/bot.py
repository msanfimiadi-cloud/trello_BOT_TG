...
def main() -> None:
    ...
    async def post_init(application: Application) -> None:
        await storage.initialize(settings.admin_telegram_user_id, settings.legacy_allowed_user_ids, settings.legacy_team)
    ...
    for command, callback in (("start", handlers.start), ("help", handlers.help), ("cancel", handlers.cancel), ("new", handlers.new), ("status", handlers.status), ("check_trello", handlers.check_trello), ("trello", handlers.trello_link), ("admin", handlers.admin), ("myid", handlers.myid)):
